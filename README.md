...
1. Download `metagen-1.0.7z` and `run_neos_metagen.bat` from the [Releases tab](https://github.com/MetaGenAI/MetaGenNeos/releases/). 
2. Unzip the contents of `metagen-1.0.7z` into the Neos installation folder, and copy `run_neos_metagen.bat` into the Neos installation folder also.
